...
M=sym('M',[Lmax,1]);S=sym('S',[Lmax,1]);E1=sym('E1',[Lmax,1]);E2=sym('E2',[Lmax,1]);I=sym('I',[Lmax,1]);A=sym('A',[Lmax,1]);Im=sym('Im',[Lmax,1]);R=sym('R',[Lmax,1]);
%ode variable
Y=sym('Y',[8*Lmax,1]);
%substitute
EQNS=subs(Equations,[M.',S.',E1.',E2.',I.',A.',Im.',R.'],Y.');
