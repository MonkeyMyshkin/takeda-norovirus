%Program to random sample vaccine scenarios and measure: total cases
%averted, cases per dose averted, deaths averted and reported cases averted
Lmax=81;
